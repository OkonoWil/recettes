...
@section('content')
    ...
    <a class="bg-green-400 text-bold text-xl w-52 font-bold hover:bg-green-500 m-1 text-white p-2 border rounded-md cursor-pointer" href="{{route('client.recettes.create')}}">
        Ajouter une recette
    </a>
    <section class="my-2">
