<nav class="h-full fixed top-0 left-0 box-border px-3 mr-3">
    ...
    <ul class="flex flex-col items-start text-xl my-5 pl-5">
        ...
        <li class="max-w-fit mt-4 border-b-2 @if(request()->is("apropos") || request()->is("apropos")) text-orange-500 border-b-orange-500  @else  border-b-gray-400 hover:text-amber-500 hover:border-b-amber-500 @endif"><a class=" hover:ml-7" href=""><i class="fa-solid fa-question-circle"></i> A propos</a></li>
        <li class="max-w-fit mt-4 border-b-2 @if(request()->is("contact") || request()->is("contact")) text-orange-500 border-b-orange-500  @else  border-b-gray-400 hover:text-amber-500 hover:border-b-amber-500 @endif"><a class=" hover:ml-7" href=""><i class="fa-solid fa-address-card"></i> Contact</a></li>
    </ul>
</nav>
